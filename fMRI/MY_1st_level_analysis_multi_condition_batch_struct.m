function first_level_analysis_mlb = MY_1st_level_analysis_multi_condition_batch_struct(output_dir,design_unit,all_epi,conds,EPI_TR,multi_regress)
...
first_level_analysis_mlb{1}.spm.stats.fmri_spec.sess.cond = conds;
